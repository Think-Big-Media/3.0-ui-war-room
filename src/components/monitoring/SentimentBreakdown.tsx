...
const SentimentBreakdown: React.FC<SentimentBreakdownProps> = ({ sentimentData }) => {
  return (
    <Card padding="md" variant="glass">
      <h3 className="text-xl font-semibold text-white/20 mb-4 font-condensed tracking-wide" style={{ textRendering: 'optimizeLegibility', WebkitFontSmoothing: 'antialiased' }}>SENTIMENT BREAKDOWN</h3>
