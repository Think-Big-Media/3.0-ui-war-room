...
const SentimentBreakdown: React.FC<SentimentBreakdownProps> = ({ sentimentData }) => {
  return (
    <Card padding="md" variant="glass">
      <h3 className="text-xl font-semibold text-white/60 mb-4 font-condensed tracking-wide" style={{ textRendering: 'optimizeLegibility', WebkitFontSmoothing: 'antialiased' }}>SENTIMENT BREAKDOWN</h3>
      <div className="space-y-4">
        ...
        <div className="w-full bg-black/20 rounded-full h-2">
          <div className={`bg-green-400 h-2 rounded-full ${getSentimentWidth(sentimentData.positive)}`} />
        </div>
        ...
        <div className="w-full bg-black/20 rounded-full h-2">
          <div className={`bg-gray-400 h-2 rounded-full ${getSentimentWidth(sentimentData.neutral)}`} />
        </div>
        ...
        <div className="w-full bg-black/20 rounded-full h-2">
          <div className={`bg-red-400 h-2 rounded-full ${getSentimentWidth(sentimentData.negative)}`} />
        </div>
      </div>
    </Card>
  );
