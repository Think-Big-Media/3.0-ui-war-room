...
export const InfluencerPowerMatrix: React.FC<InfluencerPowerMatrixProps> = ({ data }) => {
  ...
  const getQuadrantColor = (category: string) => {
    switch(category) {
      case 'champion': return 'bg-green-400 border-green-300';
      case 'amplifier': return 'bg-blue-400 border-blue-300';
      case 'watcher': return 'bg-yellow-400 border-yellow-300';
      case 'risk': return 'bg-red-400 border-red-300';
          ...
          {quadrants.map((quadrant) => (
            ...
            >
              <div className="absolute top-2 left-2">
                ...
                <div className="text-[8px] text-white/40 font-jetbrains">
                  {quadrant.desc}
                </div>
              </div>
            </div>
          ...
          return (
            ...
            >
              ...
              <div className="absolute bottom-full mb-2 opacity-0 group-hover:opacity-100 
                ...
                <div className="text-[9px] text-white/70 font-jetbrains">
                  {influencer.handle}
                </div>
