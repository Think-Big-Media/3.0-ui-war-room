    ...
    >
      ...
      <div className="flex-1 space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-sm font-bold text-purple-400 font-jetbrains">
              {viralCoeff}x
            </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-sm font-bold text-orange-400 font-jetbrains">
              {trendScore}
            </div>
      ...
      <div className="mt-2 pt-2 border-t border-white/10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <div className={`w-2 h-2 rounded-full ${velocity >= 50 ? 'bg-green-400 animate-pulse' : 'bg-yellow-400'}`} />
