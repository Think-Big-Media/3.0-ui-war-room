...
const AdPreviewModal: React.FC<AdPreviewModalProps> = ({ isOpen, campaign, onClose }) => {
 ...
 <span className="bg-yellow-400 text-black text-xs px-1.5 py-0.5 rounded font-bold">Ad</span>
 ...
 <p className="text-xs text-gray-500">Sponsored · <span className="text-blue-600">Learn more</span></p>
 </div>
 ...
 <div>
 <p className="text-sm text-gray-600">{new URL(campaign.creative.finalUrl).hostname}</p>
 ...
 <p className="text-sm">
 <span className="font-semibold">{campaign.creative.headline}</span> {campaign.creative.description}
 </p>
 ...
 <p className="text-white text-xl font-semibold">{campaign.impressions.toLocaleString()}</p>
 </div>
 <div>
 <p className="text-white/60 text-sm">Clicks</p>
 <p className="text-white text-xl font-semibold">{campaign.clicks.toLocaleString()}</p>
 </div>
 <div>
