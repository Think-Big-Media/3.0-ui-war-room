...
import { TrendingUp, Target, DollarSign, Users, BarChart3, RefreshCw, Brain, Zap, Settings2, PieChart, LineChart, AlertCircle, ChevronDown, ChevronUp, Eye, ExternalLink } from 'lucide-react';
  ...
  const mockCampaigns: AdCampaign[] = [
    {
      ...
      creative: {
        ...
        description: 'Make your voice heard in the upcoming election. Register online in just 5 minutes. Secure, official voter registration for your state.',
    ...
    },
    {
      ...
      creative: {
        ...
        description: 'Be part of the change in your neighborhood. Connect with local volunteers, attend events, and make a real difference. Together, we can build a better tomorrow.',
    ...
    },
    {
      ...
      creative: {
        ...
        description: 'Get informed about the policies that matter to you. Healthcare, education, economy - see where we stand on the issues.',
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-white">
                {filteredCampaigns.length > 0 
                  ? (filteredCampaigns.reduce((sum, c) => sum + c.ctr, 0) / filteredCampaigns.length).toFixed(2)
                  : '0.00'}%
              </p>
            </div>
              ...
              filteredCampaigns.map((campaign) => (
                <React.Fragment key={campaign.id}>
                  <tr className="border-b border-white/5 hover:bg-white/5 transition-colors cursor-pointer"
                    ...
                    <td className="p-4 text-right text-white/70">${campaign.budget.toLocaleString()}</td>
                    <td className="p-4 text-right text-white">${campaign.spent.toLocaleString()}</td>
                    <td className="p-4 text-right text-white/70">{campaign.impressions.toLocaleString()}</td>
                    <td className="p-4 text-right text-white/70">{campaign.clicks.toLocaleString()}</td>
                              ...
                              <div className="bg-white rounded-lg p-4 max-w-xl">
                                <div className="space-y-2">
                                  <div className="flex items-start gap-2">
                                    <span className="bg-yellow-400 text-black text-xs px-1 py-0.5 rounded font-semibold">Ad</span>
      ...
      <div className="bg-white/10 backdrop-blur rounded-lg p-4 mb-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white text-sm">Voter Registration Drive campaign CTR is 15% above average</p>
