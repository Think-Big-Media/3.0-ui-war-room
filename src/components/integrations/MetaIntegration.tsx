...
const MetaIntegration: React.FC = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-black/20 backdrop-blur-xl rounded-2xl p-6 border border-purple-400/30 shadow-2xl hover:bg-white/0 hover:scale-[1.02] transition-all duration-200">
