...
const GoogleAdsIntegration: React.FC = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-black/20 backdrop-blur-xl rounded-2xl p-6 border border-purple-400/30 shadow-2xl hover:bg-black/25 transition-all duration-300">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 font-medium">{formatNumber(campaign.conversions)}</p>
                      </div>
                    </div>
                  </div>
                ))}
