...
export const DualPieCharts: React.FC = memo(() => {
  ...
  const SentimentChart = () => (
    <div className="relative w-32 h-32 mx-auto">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <div className="text-2xl font-bold text-emerald-400">{sentimentPercentages.positive}%</div>
  ...
  const EmotionChart = () => (
    <div className="relative w-32 h-32 mx-auto">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <div className="text-lg font-bold text-amber-400">{emotionData.joy}%</div>
      ...
      >
        ...
        <div className="flex justify-center gap-4 mt-4">
          <div className="text-center">
            ...
            <div className="text-sm font-semibold text-amber-400">{emotionData.joy}%</div>
          </div>
          <div className="text-center">
            <div className="w-3 h-3 bg-sky-400 rounded-full mx-auto mb-1"></div>
            <div className="text-xs text-white/70">Trust</div>
            <div className="text-sm font-semibold text-sky-400">{emotionData.trust}%</div>
          </div>
          <div className="text-center">
            <div className="w-3 h-3 bg-violet-400 rounded-full mx-auto mb-1"></div>
            <div className="text-xs text-white/70">Fear</div>
            <div className="text-sm font-semibold text-violet-400">{emotionData.fear}%</div>
          </div>
          <div className="text-center">
            <div className="w-3 h-3 bg-rose-400 rounded-full mx-auto mb-1"></div>
            <div className="text-xs text-white/70">Anger</div>
            <div className="text-sm font-semibold text-rose-400">{emotionData.anger}%</div>
          </div>
        </div>
      </Card>
    </div>
