    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4">
        {actions.map((action, index) => (
          <button
            key={index}
            className={`bg-black/20 backdrop-blur-sm rounded-xl p-4 lg:p-5 border border-white/20 hover:bg-white/15 hoverable hover:scale-[1.02] transition-all duration-200 flex flex-col items-center space-y-2 quick-action-${action.accentKey} active:scale-95`}
          >
