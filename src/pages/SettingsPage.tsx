...
import { useBackgroundTheme, useBackgroundClasses, BACKGROUND_THEMES } from '../contexts/BackgroundThemeContext';
...
const SettingsPage: React.FC = () => {
  ...
  // Dropdown states - using background theme context
  ...
  // Background theme options from context
  const backgroundThemeOptions = availableThemes.map(theme => ({
    value: theme.id,
    label: theme.name
  }));
  ...
  const currentThemeConfig = BACKGROUND_THEMES[currentTheme];
                ...
                <div className="ml-1.5">
                  <CustomDropdown
                    ...
                    onChange={(themeId) => {
                      ...
                      console.log('🎨 Available themes:', Object.keys(BACKGROUND_THEMES));
                      if (themeId in BACKGROUND_THEMES) {
                        setTheme(themeId as keyof typeof BACKGROUND_THEMES);
                        console.log('✅ Theme set successfully:', themeId);
                      } else {
