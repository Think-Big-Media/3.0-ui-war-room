  ...
  return (
    ...
    >
      ...
      <div className="py-[7px] space-y-1">
        <div className="text-2xl lg:text-3xl font-bold text-white/95" style={{ font: "600 31px/37px Barlow, sans-serif" }}>
          {number}
        </div>
    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-3">
        {metrics.map((metric, index) => (
          ...
          >
            <div className="text-xl lg:text-2xl font-bold text-white/95 mb-2" style={{ font: "600 24px/32px Barlow, sans-serif" }}>
              {metric.value}
            </div>
