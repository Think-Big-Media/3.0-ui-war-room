...
export interface Database {
  public: {
    Tables: {
      organizations: {
        Row: {
          ...
          name: string
          slug: string
          org_type: 'political_campaign' | 'nonprofit' | 'advocacy_group' | 'pac' | 'union' | 'other' | null
          email: string
          phone: string | null
          website: string | null
    ...
    Enums: {
      organization_type: 'political_campaign' | 'nonprofit' | 'advocacy_group' | 'pac' | 'union' | 'other'
      subscription_tier: 'free' | 'starter' | 'professional' | 'enterprise'
      contact_type: 'voter' | 'donor' | 'volunteer' | 'supporter' | 'media' | 'vip' | 'other'
